...
/* Row 2 */
.table-grid-mode .grid-actions-cell > div > div:nth-child(5) { 
  order: 7 !important; 
  flex: 1 1 auto !important; 
  width: auto !important;
}
.table-grid-mode .grid-actions-cell > div > div:nth-child(7) { 
  order: 8 !important; 
  flex: 1 1 auto !important; 
  width: auto !important;
}
...
.table-grid-mode .grid-actions-cell .list-approval-badge-success {
  ...
  width: auto !important; /* Restored to auto so they naturally size */
