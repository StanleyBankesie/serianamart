...
router.get(
  ...
  inventoryController.listUnitConversions,
);
...
router.get(
  ...
  requireBranchScope,
  requirePermission("INV.UNIT.CONVERSION.VIEW"),
  inventoryController.getUnitConversionById,
);
...
router.post(
  ...
  inventoryController.createUnitConversion,
);
...
router.put(
  ...
  requireBranchScope,
  requirePermission("INV.UNIT.CONVERSION.MANAGE"),
  inventoryController.updateUnitConversion,
);
