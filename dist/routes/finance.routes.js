           ...
           LEFT JOIN (
             ...
             JOIN (
               ...
               WHERE company_id = :companyId
                 AND status = 'PENDING'
                 AND (
                   document_type IN ('PAYMENT_VOUCHER','RECEIPT_VOUCHER','CONTRA_VOUCHER') OR
                   document_type IN ('Payment Voucher','Receipt Voucher','Contra Voucher') OR
                   document_type IN ('PV','RV','CV')
                 )
